...
import PortData from "./data/port_data.csv";
import ShipData from "./data/ship_data.csv";
    ...
    async function fetchData() {
      try {
        if (p === 0) {
          p++;
          // PORT-------------------------------------
          const response1 = await fetch("../port_data.csv");
          ...
          // SHIP-------------------------------------
          const ship = {};
          const response = await fetch("../ship_data.csv");
